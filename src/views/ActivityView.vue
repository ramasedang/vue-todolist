        ...
        <div class="m-3 row justify-content-between">
            <div class="col-4">
                ...
                <div class="row row-cols-3">
                    ...
                    <div class="p-2"><button class="btn btn-primary text-white btn-circle" type="button" data-bs-toggle="modal"
                            data-bs-target="#editnameActivity"><svg xmlns="http://www.w3.org/2000/svg" width="16"
