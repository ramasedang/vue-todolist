<template>
  <div class="container">
    <div class="m-3 row justify-content-between">
      <div class="col-4">
        <div class="row row-cols-3">
          <div class="col">
            <router-link class="previous round" to="/"
              >&#8249;</router-link
            >
          </div>
          <div class="col">
    ...
    <div v-if="bg_hide == false">
      <img
        src="https://devcode-simple-todo-list.vercel.app/img/todo-empty-state.2aa44541.svg"
        alt=""
      />
    </div>
    ...
    <div v-else>
      <CardTask
        ...
        :key="index"
        :nameTask="data.name"
        :priorityTask="data.priority"
        :categoryTask="data.category"
...
import { getDataTask, getData, addTask } from '@/firebase/index';
